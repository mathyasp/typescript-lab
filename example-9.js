...
function rampage(kaiju, city) {
    ...
    var action;
    switch (type) {
        case example_8_2.KaijuType.ape:
            action = 'smash';
            break;
        case example_8_2.KaijuType.lizard:
            action = 'burn';
            break;
        case example_8_2.KaijuType.flying:
            action = 'flap';
            break;
    }
...
var gojira = new example_8_1.Kaiju('Gojira', 90, example_8_2.KaijuType.lizard);
